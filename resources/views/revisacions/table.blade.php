    ...
    @foreach($revisacions as $revisacion)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('revisacions.show', [$revisacion->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                    <a href="{!! route('revisacions.edit', [$revisacion->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
